...
public class Main {
    ...
    static void menu(){
        ...
        while(true){
            ...
            System.out.println("4- BUSCAR EL CAMINO MAS CORTO ENTRE CIUDADES");
            ...
            switch (opcion){
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        System.out.println("Chao cuidese :D");
                        return;
                    default:
    ...
    static void registrarR(){
        System.out.println("Ingresar ID origen");
        int id1 = tcld.nextInt();

        System.out.println("Ingresar ID destino");
        int id2 = tcld.nextInt();

        System.out.println("Ingresar costo de la ruta");
    ...
    static void BuscarG(){
        System.out.print("Ingresar la cantidad de ciudades gate que quiere buscar: ");
        int k = tcld.nextInt();
    ...
    static void pruebas(){
        ...
        //Cauquenes -> Chillán -> Santiago cuesta 300 en total, debería dar distinto
        ...
        System.out.println("Ruta hacia si mismo (debe dar false): " + redCiudad.registrarRuta(0, 0, 10));
        ...
        System.out.println("Calculando camino minimo desde Cauquenes 0 a Santiago 2");
